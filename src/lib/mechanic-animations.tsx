...
export const MECHANIC_ANIMATIONS: MechanicAnimation[] = [
  { id: "resource-management", title: "Collect & Manage", description: "Gather items, track totals, and hit exact targets", mathDomain: "arithmetic operations",
    descKeywords: ["add and subtract", "four operations", "word problems", "multi-step", "remainders", "whole number", "fluently add", "fluently subtract", "factors and multiples"],
    domainCodes: ["OA"],
  ...
  { id: "construction-systems", title: "Build & Measure", description: "Stack and build to hit exact dimensions", mathDomain: "area and volume",
    descKeywords: ["area", "volume", "perimeter", "surface area", "rectangle", "rectangular array", "square unit", "cubic", "tile", "area using multiplication", "relate area"],
    domainCodes: ["G-GMD", "G-MG", "MD"],
  ...
  { id: "above-below-zero", title: "Rise & Fall", description: "Move above and below zero on a number line", mathDomain: "signed numbers and absolute value",
    descKeywords: ["negative number", "absolute value", "integer", "opposite", "sea level", "above zero", "below zero", "elevation", "temperature", "credit", "debit", "rational number", "number line", "positive and negative", "adding and subtracting rational", "directed numbers"],
    domainCodes: ["NS"],
